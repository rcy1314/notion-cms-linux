...
var tweet_html_1 = require("./tweet-html");
var api_1 = require("./api");
var fetchTweetAst_1 = require("../fetchTweetAst");
var markdownToAst_1 = __importDefault(require("../markdown/markdownToAst"));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, api_1.fetchUserStatus(tweet.meta.id)];
                case 1:
                    userStatus = _a.sent();
                    video = userStatus && getVideoData(userStatus);
                    media = video ? tweet_html_1.getVideo(media, video) : null;
                    _a.label = 2;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, api_1.getEmbeddedTweetHtml(quotedTweet.url)];
                case 1:
                    data = _b.sent();
                    return [2 /*return*/, data === null || data === void 0 ? void 0 : data.html];
                case 2: return [4 /*yield*/, fetchTweetAst_1.fetchTweetAst(quotedTweet.id)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, api_1.fetchTweetWithPoll(tweet.meta.id)];
                case 1:
                    tweetData = _a.sent();
...
function getTweetHtml(tweet, context) {
    return __awaiter(this, void 0, void 0, function () {
        var meta, md, html, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, markdownToAst_1["default"](tweet.html)];
                case 1:
                    md = _b.sent();
                    _a = [
