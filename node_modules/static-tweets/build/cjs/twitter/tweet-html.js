...
exports.getTweetData = exports.getVideo = void 0;
    ...
    tweetContent.children('a').each(function () {
        ...
        if (props['data-pre-embedded'] === 'true') {
            ...
            if (isVideo) {
                ...
                var url = new url_1.URL(img.slice(4, -1).replace(/['"]/g, ''));
                var fileName = path_1["default"].basename(url.pathname);
