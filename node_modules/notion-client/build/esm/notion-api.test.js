...
var pageIdFixturesFailure = [
    'bdecdf150d0e40cb9f3412be132335d4',
    'foo' // invalid page id
];
var _loop_1 = function (pageId) {
    test("NotionAPI.getPage success " + pageId, function (t) { return __awaiter(void 0, void 0, void 0, function () {
        var api, page;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    api = new NotionAPI();
                    return [4 /*yield*/, api.getPage(pageId)];
                case 1:
                    page = _a.sent();
                    t.truthy(page);
                    t.truthy(page.block);
...
for (var _i = 0, pageIdFixturesSuccess_1 = pageIdFixturesSuccess; _i < pageIdFixturesSuccess_1.length; _i++) {
    var pageId = pageIdFixturesSuccess_1[_i];
    _loop_1(pageId);
}
var _loop_2 = function (pageId) {
    test("NotionAPI.getPage failure " + pageId, function (t) { return __awaiter(void 0, void 0, void 0, function () {
        var api;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    api = new NotionAPI();
                    return [4 /*yield*/, t.throwsAsync(function () { return api.getPage(pageId); })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
for (var _a = 0, pageIdFixturesFailure_1 = pageIdFixturesFailure; _a < pageIdFixturesFailure_1.length; _a++) {
    var pageId = pageIdFixturesFailure_1[_a];
    _loop_2(pageId);
}
//# sourceMappingURL=notion-api.test.js.map