...
export var useTweet = function () { return React.useContext(TweetContext); };
export default function Tweet(_a) {
    var children = _a.children, data = _a.data;
    return (React.createElement("div", { className: 'static-tweet-body' },
        React.createElement("blockquote", { className: 'static-tweet-body-blockquote' },
