...
export var A = function (p) { return (React.createElement("a", { href: p.href, target: '_blank', rel: 'noopener noreferrer', title: p.title || p.href, className: cs('static-tweet-anchor', p.className) }, p.children[0] === p.href ? beautifyHref(p.href) : p.children)); };
