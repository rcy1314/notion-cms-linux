...
export var Block = function (props) {
    ...
    switch (block.type) {
                    ...
                    return (React.createElement("div", { className: cs('notion', 'notion-app', darkMode ? 'dark-mode' : 'light-mode', blockId, className) },
                        ...
                        React.createElement("div", { className: 'notion-frame' },
                            ...
                            React.createElement("div", { className: 'notion-page-scroller' },
                                hasPageCover ? (pageCover ? (pageCover) : (React.createElement(LazyImage, { src: mapImageUrl(page_cover, block), alt: getTextContent(properties_1 === null || properties_1 === void 0 ? void 0 : properties_1.title), className: 'notion-page-cover', style: {
                                ...
                                React.createElement("main", { className: cs('notion-page', hasPageCover
                                    ...
                                    React.createElement("h1", { className: 'notion-title' },
                                        React.createElement(Text, { value: properties_1 === null || properties_1 === void 0 ? void 0 : properties_1.title, block: block })),
                                    block.type === 'page' &&
        ...
        case 'sub_sub_header': {
            ...
            var classNameStr = cs(isH1 && 'notion-h notion-h1', isH2 && 'notion-h notion-h2', isH3 && 'notion-h notion-h3', blockColor_2 && "notion-" + blockColor_2, indentLevelClass, blockId);
