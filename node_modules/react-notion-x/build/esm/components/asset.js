...
export var Asset = function (_a) {
    ...
    var _k = useNotionContext(), recordMap = _k.recordMap, mapImageUrl = _k.mapImageUrl, components = _k.components;
    ...
    if (block.format) {
        var _l = block.format, block_aspect_ratio = _l.block_aspect_ratio, block_height = _l.block_height, block_width = _l.block_width, block_full_width = _l.block_full_width, block_page_width = _l.block_page_width, block_preserve_scale = _l.block_preserve_scale;
    ...
    if (block.type === 'tweet') {
        ...
        var signedUrl = (_h = recordMap.signed_urls) === null || _h === void 0 ? void 0 : _h[block.id];
        var src = mapImageUrl(signedUrl || source, block);
        var caption = getTextContent((_j = block.properties) === null || _j === void 0 ? void 0 : _j.caption);
        var alt = caption || 'notion image';
        content = (React.createElement(LazyImage, { src: src, alt: alt, style: assetStyle, zoomable: false, height: style.height }));
    }
